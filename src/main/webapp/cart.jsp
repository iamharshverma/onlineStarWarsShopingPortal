...
<body>
	...
	<div class="navbar-inner">
		<a class="brand" href="home.jsp">The Pirate Shop</a> <a
	...
	<div class="container">
		...
		<div class="table-responsive cart_table">
			<c:choose>
				...
				<c:when test="${cart.numberOfItems > 99}">
                            				<c:choose>
                            									...
                            									<div class="well">
                            										<table class="table table-condensed total-result">
                            											...
                            											<tr class="shipping-cost">
                            												<td>Discount Applied(on Total)</td>
                            												<td>5%</td>
                            											</tr>
                            											<tr>
										...
										<div class="form-horizontal">
											<form action="update" method="POST">
												<input type="hidden" name="productid"
													...
													type="number" name="quantity" size="3" maxlength="5"
													class="input-mini" max="150" min="1"
